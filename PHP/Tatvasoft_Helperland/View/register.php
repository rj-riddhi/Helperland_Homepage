		...
		<div class="container-fluid p-0  main_container">
			...
			<section >
				...
				<div class="container mx-auto form_container">
					...
					<form name="form1" action="#" class="needs-validation" novalidate>
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<div class="input-group mb-2">
									...
									<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Mobile number" maxlength="10">
								</div>
							</div>
							
							<div class="form-group col-md-6">
								<input type="password" class="form-control" pattern="/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{6,14}$/" id="Password" placeholder="Password" required >
						...
						<div class="form-group  text-center">
							<div class="col-12">
								<button class="btn sub_btn  btn-rounded" type="submit">Register</button>
							</div>
							<div class="col-12 mt-2">
								<p >Already Registered? <span> <a href="homepage.php" data-target="#myModal" >Login Now</a></span></p>
							</div>
