<?php
	...
	public function register($data){
		...
		$insert_query = "INSERT INTO user (FirstName,LastName,Email,Password,Mobile,UserTypeId,IsRegisteredUser,CreatedDate,IsActive,Status,UserProfilePicture) VALUES ('$Firstname','$LastName','$Email','$Password','$Mobile','$UserTypeId','$IsRegisteredUser','$CreatedDate','$IsActive','$Status','$avtar')" ;
    ...
    public function login($email, $password){
        ...
        if(password_verify($password, $hashedPassword)){
            $query_update = "UPDATE user SET Status ='1' WHERE IsActive = '1' && Email = '$email'  ";
    ...
    public function firstlogin($email,$password){
         $row = $this->findUserByEmailOrUsername($email, $email);
        ...
        if(password_verify($password, $hashedPassword)){
            $query_update = "UPDATE user SET IsActive = '1' WHERE   Email = '$email'  ";
            $result_update = mysqli_query($this->conn , $query_update);
    ...
    public function changestatus($email){
        $query_update = "UPDATE user SET Status = '0' WHERE Email = '$email'";
...
else
{
    ...
    public function deleteUserAddress($data){
        $addid = $data['addid'];
        $delet_query = "DELETE FROM useraddress WHERE AddressId = '$addid'";
        $result = mysqli_query($this->conn,$delet_query);
        return $result;
    }
    // Favourite Pros
    public function getBlockServiceProviders($custid)
    {
        $select_query = "SELECT DISTINCT ServiceProviderId from servicerequest WHERE UserId = '$custid' && Status = 'completed'";
        $result = mysqli_query($this->conn,$select_query);
        $i=0;
            $arr = array();
            while($array = mysqli_fetch_assoc($result)){
    ...
    public function blockCustomer($userid,$targetuserid){
        $query_update = "SELECT * FROM favoriteandblocked WHERE UserId = '$targetuserid' && TargetUserId = '$userid'";
        $result = mysqli_query($this->conn , $query_update);
        $rows = mysqli_num_rows($result);
        if($rows == 0){
            ...
            $query_update = "UPDATE favoriteandblocked SET IsBlocked ='1' WHERE UserId = '$targetuserid' && TargetUserId = '$userid'";
            $result3 = mysqli_query($this->conn , $query_update);
            return $result3;
        }
        
    }
    public function blockServiceProvider($userid,$targetuserid){
        $query_update = "SELECT * FROM favoriteandblocked WHERE UserId = '$userid' && TargetUserId = '$targetuserid'";
        $result = mysqli_query($this->conn , $query_update);
        $rows = mysqli_num_rows($result);
        if($rows == 0){
            $insert_query = "INSERT INTO favoriteandblocked (UserId,TargetUserId,IsBlocked,IsFavorite) VALUES ('$userid','$targetuserid','1','0')";
            $result2 = mysqli_query($this->conn,$insert_query);
            return $result2;
        }
        else{
            $select_query = "SELECT * FROM favoriteandblocked WHERE UserId = '$userid' && TargetUserId = '$targetuserid' && IsFavorite = '1' ";
            $result4 = mysqli_query($this->conn, $select_query);
            $rows2 = mysqli_num_rows($result4);
            if($rows2 > 0){

            }
            else{
            $query_update = "UPDATE favoriteandblocked SET IsBlocked ='1',IsFavorite='0' WHERE UserId = '$userid' && TargetUserId = '$targetuserid'";
            $result3 = mysqli_query($this->conn , $query_update);
            return $result3;
            }
        }
    ...
    public function unBlockServiceProvider($userid,$targetuserid){
        $query_update = "UPDATE favoriteandblocked SET IsBlocked ='0' WHERE UserId = '$userid' && TargetUserId = '$targetuserid'";
        $result = mysqli_query($this->conn , $query_update);
        return $result;
    ...
    public function favouriteServiceProvider($userid,$targetuserid){
        $query_update = "SELECT * FROM favoriteandblocked WHERE UserId = '$userid' && TargetUserId = '$targetuserid'";
        $result = mysqli_query($this->conn , $query_update);
        $rows = mysqli_num_rows($result);
        if($rows == 0){
            $insert_query = "INSERT INTO favoriteandblocked (UserId,TargetUserId,IsFavorite) VALUES ('$userid','$targetuserid','1')";
            $result2 = mysqli_query($this->conn,$insert_query);
            return $result2;
        }
        else{
            $select_query = "SELECT * FROM favoriteandblocked WHERE UserId = '$userid' && TargetUserId = '$targetuserid' && IsBlocked = '1' ";
            $result4 = mysqli_query($this->conn, $select_query);
            $rows2 = mysqli_num_rows($result4);
            if($rows2 > 0){
               ...
               $query_update = "UPDATE favoriteandblocked SET IsFavorite ='1' WHERE UserId = '$userid' && TargetUserId = '$targetuserid'";
            $result3 = mysqli_query($this->conn , $query_update);
            return $result3; 
            }
    ...
    public function unFavouriteServiceProvider($userid,$targetuserid){
        $query_update = "UPDATE favoriteandblocked SET IsFavorite ='0' WHERE UserId = '$userid' && TargetUserId = '$targetuserid'";
        $result = mysqli_query($this->conn , $query_update);
        return $result;
    ...
    public function getSpRatings($spid){
        ...
        $select_query = "SELECT DISTINCT  ServiceRequestId,RatingFrom From rating WHERE RatingTo = '$spid'";
        $result = mysqli_query($this->conn,$select_query);
        $i=0;
            $arr = array();
            while($array = mysqli_fetch_assoc($result)){
    ...
    public function getSpRatings2($spid,$serviceid){
        $select_query = "SELECT  Ratings,Comments From rating WHERE RatingTo = '$spid' && ServiceRequestId = '$serviceid'";
        $result = mysqli_query($this->conn,$select_query);
        $rows = mysqli_num_rows($result);
        $i=0;
        $average = 0;
        $comments ="";
            ...
            return array($average,$comments);
    }

    public function getSpAverageRatings($spid){
    ...
    public function getFavUnfavouriteSp($custid,$spid){
        $select_query = "SELECT DISTINCT * FROM favoriteandblocked WHERE UserId = '$custid' && TargetUserId = '$spid' && IsFavorite = '1'";
        $result = mysqli_query($this->conn,$select_query);
        $rows = mysqli_num_rows($result);
        return $rows;

    }
    public function getBlockUnblockSp($custid,$spid){
        $select_query = "SELECT DISTINCT * FROM favoriteandblocked WHERE UserId = '$custid' && TargetUserId = '$spid' && IsBlocked = '1'";
        $result = mysqli_query($this->conn,$select_query);
        $rows = mysqli_num_rows($result);
        return $rows;
    ...
    public function getUserRole(){
        $select_query = "SELECT DISTINCT UserTypeId From user";
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
            $arr[$i] = $array['UserTypeId'];
            $i++;
        }
        return $arr;
    }
    ...
    public function getUserName(){
        $select_query = "SELECT DISTINCT Firstname,LastName From user where UserTypeId != '3'";
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
            $arr[$i] = $array['Firstname'].' '.$array['LastName'];
            $i++;
        }
        return $arr;
    }
    ...
    public function getPostalCode(){
        $select_query = "SELECT ZipcodeValue FROM zipcode";
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
            $arr[$i] = $array['ZipcodeValue'].' ';
            $i++;
        }
        return $arr;
    }
    public function getDataFromRole($role){
        $select_query = "SELECT * FROM user WHERE UserTypeId = '$role' || ZipCode = '$role' || Mobile = '$role' || Email = '$role' || substr(CreatedDate,1,10) = '$role' || FirstName = '$role'";
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
    ...
    public function getDataFromStartAndEnddate($startdate,$enddate){
        $select_query = "SELECT * FROM user WHERE substr(CreatedDate,1,10) >= '2022-02-02' && substr(CreatedDate,1,10) <= '2022-02-15';";
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
    ...
    public function getChangedZipCode($email){
        $select_query = "SELECT DISTINCT PostalCode FROM useraddress WHERE Email = '$email'";
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
            $arr[$i] = $array['PostalCode'].' ';
            $i++;
        }
        return $arr;
    }
    ...
    public function getUsers(){
     ...
     public function changeactivestatus($name){
        $select_query = "SELECT IsActive FROM user WHERE FirstName = '$name'";
        $result1 = mysqli_query($this->conn,$select_query);
        $array = mysqli_fetch_assoc($result1);
        if($array['IsActive'] == 1){
        $query_update = "UPDATE user SET IsActive = '0' WHERE FirstName = '$name'";
        $result = mysqli_query($this->conn , $query_update);
        return $result;
    }
    else
    {
        $query_update = "UPDATE user SET IsActive = '1' WHERE FirstName = '$name'";
        $result = mysqli_query($this->conn , $query_update);
        return $result;
    }
    }
    ...
    public function deleteUser($name){
        $delete_query = "DELETE FROM user WHERE FirstName = '$name'";
    ...
    public function getAllServicesData(){
      $select_query = "SELECT * FROM servicerequest" ;
            $result = mysqli_query($this->conn,$select_query);
           $i=0;
            $arr = array();
            while($array = mysqli_fetch_assoc($result)){
    ...
    public function SpAvilabilityOnNewPostal($spid,$postalcode){
        $select_query = "SELECT * FROM useraddress WHERE UserId = '$spid' && PostalCode = '$postalcode'";
        $result = mysqli_query($this->conn,$select_query);
        $rows = mysqli_num_rows($result);
        return $rows;
    }    
    public function updateRequestByAdmin($data){
        $date = $data['date'];
        $time = $data['time'];
        $street = $data['street'];
        $housenumber = $data['housenumber'];
        ...
        $serviceid = $data['serviceid'];
        $date_time = $date ." ".$time;
       $update_query = "UPDATE servicerequest SET ServiceStartDate = '$date_time', ZipCode = '$postalcode' , ModifiedDate = '$currentdate' , ModifiedBy = '$modifier' , HasIssue = '$reason' WHERE ServiceId = '$serviceid'";
        $result = mysqli_query($this->conn,$update_query);
        $rows = mysqli_affected_rows($this->conn);
        if($rows > 0){
                $array = $this->City($postalcode);
                $state = $array[1];
                $update_address = "UPDATE servicerequestaddress SET AddressLine1 = '$street' , AddressLine2 = '$housenumber' , City = '$city' , State = '$state', PostalCode = '$postalcode' WHERE ServiceRequestId = '$serviceid'";
                $result2 = mysqli_query($this->conn,$update_address);
                $rows2 = mysqli_affected_rows($this->conn);
                if($rows > 0){
                    return '1';
                }
                else{
    ...
    public function getDataFromData($data){
        $select_query = "SELECT * FROM servicerequest WHERE ServiceId = '$data' || ZipCode = '$data' || UserId = '$data' || ServiceProviderId = '$data' || PaymentDone = '$data' || Status = '$data' || substr(ServiceStartDate,1,10) = '$data'";
        //  || Mobile = '$data'  ||  || FirstName = '$data'
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
    ...
    public function getServiceFromStartAndEnddate($startdate,$enddate){
        $select_query = "SELECT * FROM servicerequest WHERE substr(CreatedDate,1,10) >= 'startdate' && substr(CreatedDate,1,10) <= 'enddate';";
        $result = mysqli_query($this->conn,$select_query);
        $arr = array();
        $i = 0;
        while($array = mysqli_fetch_assoc($result)){
     ...
     public function deleteservicebyAdmin($data){
        $delet_query = "DELETE FROM servicerequest WHERE ServiceId = '$data'";
        $result = mysqli_query($this->conn,$delet_query);
        $rows = mysqli_affected_rows($this->conn);
        return $rows;
    }
    public function delteserviceaddressbyAdmin($id){
        $delet_query = "DELETE FROM servicerequestaddress WHERE ServiceRequestId = '$id' ";
        $result = mysqli_query($this->conn,$delet_query);
        $rows = mysqli_affected_rows($this->conn);
        return $rows;
