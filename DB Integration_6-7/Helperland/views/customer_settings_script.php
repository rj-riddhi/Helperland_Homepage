...
function saveeditedaddress(){
    ...
    if (confirm("Do you really want to Edit this address?")) {
...
function saveaddress(){
    ...
    var postalcode = document.getElementById("pincode2").value;
    var city = document.getElementById("location2").text;
...
function deleteaddress(id){
    ...
    var jsondata = JSON.stringify(formdata);
    fetch("http://localhost/Helperland/controllers/Customer_Pages.php?q=deleteaddress",{
        method : 'POST',
        body : jsondata,
        headers : {
          'Content-Type' :'application/json',
