...
<html>
	...
	<body>
		<div class="container-fluid p-0 mx-auto main_container">
			<!-- HEADER -->
			...
			<section>
				<div class="row ">
					<div class="col">
					<img class="banner"src="images/FAQ/banner.png"></div>
				</div>
				...
				<div class="row text-center">
					<div class="col">
						<img  src="images/FAQ/faq_star.png">
					</div>
				</div>
				<div class="container container2 mx-auto" >
					...
					<div class="row text-center">
            <div class="col p-0 "><a  style="text-decoration: none;"><p style="background-color: #1D7A8C ; color:#FFFFFF ; line-height: 52px; border-bottom: 2px solid #1D7A8C ;cursor:pointer">FOR CUSTOMER</p></a></div>
            <div class="col p-0"  ><a   style="text-decoration: none;"><p style="background-color:  #F6F6F6; color:#525252  ; line-height: 52px; border-bottom: 2px solid #1D7A8C;cursor:pointer">FOR SERVICE PROVIDER</p></a></div>
            <!--  -->
             <!--  -->
            ...
            <div class="col p-0">
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="headingOne" >
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
              ...
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="headingTwo" >
                  ...
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
              ...
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="headingThree" >
                  ...
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
                  <!-- </button> -->
                  <p class="mb-0 ml-4" style="font-weight: bold;">
              ...
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="headingFour" >
                  <!-- <button class="btn btn-link" > -->
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
                  <!-- </button> -->
                  <p class="mb-0 ml-4" style="font-weight: bold;">
            ...
            <div class="col p-0" style="visibility: hidden">
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="haddingFive" >
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
                  <p class="mb-0 ml-4" style="font-weight: bold;">
                    What's included in a cleaning?
                  </p>
                </div>
              ...
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="headingSix" >
                  ...
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
              ...
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="headingSeven" >
                  <!-- <button class="btn btn-link" > -->
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
                  <!-- </button> -->
                  <p class="mb-0 ml-4" style="font-weight: bold;">
                    Can I skip or reschedule bookings?
                  </p>
              ...
              <div class="card ">
                <div class="card-header pl-0 d-flex border-0" id="headingEight" >
                  <!-- <button class="btn btn-link" > -->
                  <a class="btn-link collapsed"data-toggle="collapse" data-target="#collapseEight" aria-expanded="true" aria-controls="collapseEight"><span class="icon"><img src="images/FAQ/right-arrow.png"></span></a>
                  <!-- </button> -->
                  <p class="mb-0 ml-4" style="font-weight: bold;">
                    Do I need to be home for the booking?
                  </p>
      ...
      <!-- <script>
        function headingone(){
          document.getElementById("headingone").classList.add("headingone");
        }
      </script> -->
