...
<head>
  ...
  <title>Upcomming Services</title>
</head>
<body >
...
<div class="col service_history">Upcoming Services</div>
<table class="table table-hover table-bordered" id="myTable">
  <thead style="position: sticky;top: 0">
    <tr >
      ...
      <th class="header"scope="col">Complete </th>
...
<div class="modal fade " id="summaryModal2"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow-y: hidden">
      ...
      <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="modal-footer justify-content-start">
          <!-- <div class="row"> -->
            <span class="badge_cancel " onclick="cancel(this.id)" data-dismiss="modal">
              <i class="fa fa-times"></i> Cancel</span>
            <span class="badge_complete " onclick="complete(this.id)" data-dismiss="modal">
