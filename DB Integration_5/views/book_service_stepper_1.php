...
<?php if(isset($_SESSION['postalcode']))
     ...
     var time = document.getElementById('time').value;
      ...
      function hrschanged(value){
        hrs = parseInt(value);
        document.getElementById("basic").innerHTML = hrs;
        hrs += extrahrs;
        if(hrs < 3){
          show_msg("error","Minimum selected hrs should be 3 hours");
          $("#hrs").focus();
          return false;
        }
        else{
...
function bookingcomplete()
  {
    ...
    if(filledmonth > 12 || filledmonth < 01 ){
      document.getElementById('cardnumber').value = cardnumber;
      show_msg("error","Month should be from '01' to '12' or should greater than current month");
      return false;
    }
    if(filledmonth <= currentmonth){
      document.getElementById('cardnumber').value = cardnumber;
      show_msg("error","You are entering old month");
      return false;
    }
    ...
    document.getElementById("expdate").value = filledmonth+'/';
      show_msg("error","Exp year is not valid ");
      return false;
    }
