                      ...
                      <div class="col form-group">
                        ...
                        <div class="row form-row">
                          ...
                          <div class="col-md-2 col">
                            <div class="input-group m-0">
                              <input type="number" class="form-control"name="bath"id="bath" placeholder="1 bath" value="<?php if(isset($_SESSION['bath'])) echo $_SESSION['bed'] ?>"required>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="input-group row" >
                      <div class="col ">
                        ...
                        <div class="row form-row">
                          <div class="col">
                            <div class="input-group m-0">
                              <input type="text" id = "datepicker-5" name="date" id="date" class="form-control  datepicker-7" placeholder="01/01/2018" value="<?php if(isset($_SESSION['date'])) echo $_SESSION['date'] ?>"required>
                            </div>
                          </div>
                          <div class="col">
                            <div class="input-group m-0">
